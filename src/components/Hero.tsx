...
const Hero = () => {
  ...
  return (
    <section id="top" className="min-h-screen flex flex-col justify-center relative pt-20 pb-16">
      <div className="container">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
            <span ref={firstNameRef} className="transition-all duration-700 opacity-0 translate-y-8 inline-block">
              <span className="text-primary">Jay</span>
            </span>{" "}
            <span ref={lastNameRef} className="transition-all duration-700 opacity-0 translate-y-8 inline-block">
              Chaniyara
            </span>
          </h1>
          ...
          >
            Results-driven and detail-oriented full-stack developer with 2+ years of experience
            in building scalable web applications using Angular, .NET Core, and SQL Server.
          </p>
