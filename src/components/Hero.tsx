...
const Hero = () => {
  ...
  const typedText = useTypingEffect(
    "Results-driven and detail-oriented full-stack developer with 3.5+ years of experience in building scalable web applications using Angular, React, MVC, .NET Core, and SQL Server.",
    25
  );
  useEffect(() => {
    const elements = [
