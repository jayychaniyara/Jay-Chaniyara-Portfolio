            ...
            >
              ...
              {project.language && (
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-2 py-1 text-xs rounded-full bg-secondary border border-border">
                    {project.language}
                  </span>
                  {project.topics?.slice(0, 3).map((topic) => (
                    <span 
                      key={topic}
                      className="px-2 py-1 text-xs rounded-full bg-secondary border border-border"
                    >
                      {topic}
                    </span>
                  ))}
